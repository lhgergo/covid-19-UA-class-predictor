...
function(input, output) {
    ...
    origin_date <- as.Date("2020-11-13")
    ...
    output$latest_classification_df <- renderDataTable(data.frame(mutual_countries, vals))
    ...
    # }) -> vals
    # 
    # output$next_classification_df <- data.frame(mutual_countries, vals) %>% renderDataTable()
